...
import logo from "../assets/berbagi_logo.png";

const isNotActiveStyle =
  "flex items-center px-5 gap-3 text-gray-500 hover:text-black transition-all duration-200 ease-in-out capitalize";
const isActiveStyle =
  "flex items-center px-5 gap-3 font-extrabold bolder-r-2 border-black transition-all duration-200 ease-in-out capitalize";
